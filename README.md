...
Projeto de portfólio pessoal desenvolvido utilizando apenas HTML e CSS.
...
- Exibição de projetos com imagem  
- Links para GitHub e LinkedIn  
- Layout responsivo  
- Tema escuro (preto e verde)

## 📌 Objetivo
Projeto criado para apresentar meus conhecimentos em desenvolvimento web,
